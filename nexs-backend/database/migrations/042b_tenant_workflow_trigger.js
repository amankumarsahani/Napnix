...
module.exports = async function(connection) {
    ...
    const emailBody = [
        ...
        '<h1 style="color:#ffffff;margin:0;font-size:24px;">Napnix</h1>',
        ...
        '<p style="color:#334155;">Thank you for choosing <strong>Napnix</strong> as your CRM partner. Please find attached your <strong>Service Agreement</strong> for the <strong>{{plan_name}}</strong> plan.</p>',
        ...
        '<p style="color:#334155;">Best regards,<br><strong>Napnix Team</strong></p>',
        '</div>',
    ...
    const [n2] = await connection.query(
        ...
        [wfId, JSON.stringify({
            ...
            attachment_filename: 'Napnix-Agreement-{{slug}}.pdf'
        })]
    );
