...
const features = [
    ...
    { title: 'CRM Integration', desc: 'Native sync with NapCRM. Contacts auto-imported from leads and customers.', icon: RiLinksLine, color: 'text-orange-600', bg: 'bg-orange-50' },
...
const howItWorks = [
    ...
    { step: '02', title: 'Import Contacts', desc: 'Upload CSV, sync from NapCRM, or add manually. Tags and segments included.', icon: RiUserFollowLine },
...
const analyticsHighlights = [
    {
        ...
        desc: 'Every visit to /napmail is captured in Site Analytics with clean route-level page tracking.',
    ...
    },
    {
        ...
        desc: 'Traffic from NapMail campaigns and landing sessions can be analysed in the Site Analytics AI panel.',
        icon: RiLinksLine,
...
const comparisonItems = [
    ...
    { feature: 'NapCRM Native Integration', nexmail: true, mailchimp: false, brevo: false },
...
const faqs = [
    { q: 'Can I use my own SMTP servers?', a: 'Yes! NapMail is BYOS (Bring Your Own SMTP). Add unlimited accounts from Gmail, Amazon SES, Postmark, SendGrid, or any SMTP provider. NapMail rotates between them intelligently.' },
    ...
    { q: 'What is domain throttling?', a: 'Major email providers (Gmail, Yahoo, Outlook) have strict per-hour limits. NapMail respects these limits automatically — for example, max 80 emails/hour to Gmail addresses — so your sender reputation stays protected.' },
    { q: 'How does SMTP rotation work?', a: 'When you add multiple SMTP accounts, NapMail uses weighted rotation — accounts with better reputation scores and lower usage get selected more often. If one account hits its daily limit, NapMail seamlessly switches to the next.' },
    { q: 'Does it integrate with NapCRM?', a: 'Natively. When a lead or customer is created in NapCRM, their contact is auto-synced to NapMail. You can segment by CRM source, tags, and custom fields.' },
...
export default function NapMailLandingPage() {
    ...
    const submitContactForm = useCallback(async (formData) => {
        ...
        const data = {
            ...
            message: `Plan: NapMail ${selectedPlan || 'General'}\n\n${formData.get('message') || 'Interested in NapMail.'}`,
        };
        try {
        ...
        <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden selection:bg-[#2563EB]/10">
            ...
            <script type="application/ld+json">{JSON.stringify({
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 2, "name": "NapMail", "item": `${SITE_URL}/napmail` }
                ]
            })}</script>
            <script type="application/ld+json">{JSON.stringify({
                    ...
                    <FadeIn y={20}>
                        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between mb-8">
                            <div className="max-w-2xl">
                                ...
                                <h2 className="text-3xl md:text-4xl font-bold text-slate-900">NapMail landing traffic is already measurable.</h2>
                                <p className="text-lg text-slate-600 mt-4">
                                    The public NapMail landing page lives at <span className="font-semibold text-slate-900">/napmail</span> and is wired into the shared telemetry pipeline for page views, click maps, and AI analysis.
                                </p>
                            </div>
                            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm text-slate-600 max-w-md">
                                Use the <span className="font-semibold text-slate-900">Site Analytics</span> dashboard to review the selected date range, CTA click hotspots, and journey drop-offs for the NapMail landing path.
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <FadeIn y={24} duration={0.6}>
                        <div className="max-w-3xl mx-auto text-center mb-16">
                            ...
                            <p className="text-xl text-slate-600 font-light">Here&apos;s what your NapMail dashboard looks like on day one.</p>
                        </div>
                    </FadeIn>
                    ...
                    <FadeIn y={40} duration={0.8}>
                        <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl shadow-slate-300/30 overflow-hidden">
                            <div className="bg-slate-100 border-b border-slate-200 px-5 py-3 flex items-center gap-3">
                                ...
                                <span className="text-xs font-medium text-slate-400 ml-2">NapMail — Campaign Dashboard</span>
                            </div>
                                ...
                                <div className="flex-1 p-5 md:p-8 space-y-6 min-w-0">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center justify-between bg-blue-50 rounded-xl border border-blue-100 px-5 py-4 gap-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <span className="text-xs font-semibold text-slate-800">NapCRM Integration</span>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <FadeIn y={24}>
                        <div className="text-center mb-14">
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">NapMail vs Competitors</h2>
                            <p className="text-lg text-slate-500 max-w-2xl mx-auto">See what makes NapMail different from Mailchimp and Brevo.</p>
                        </div>
                    </FadeIn>
                            ...
                            <div className="overflow-x-auto">
                                <div className="min-w-[600px]">
                                    <div className="grid grid-cols-[1.5fr_1fr_1fr_1fr] bg-slate-50/50 border-b border-slate-200">
                                        ...
                                        <div className="py-4 px-4 text-center text-sm font-bold text-[#2563EB]">NapMail</div>
                    ...
                    <FadeIn y={20} delay={0.1}>
                        <div className="relative">
                            <AnimatePresence mode="wait">
                                {[
                                    {
                                        quote: 'We moved from Mailchimp to NapMail and our deliverability jumped from 82% to 96%. The SMTP rotation and domain throttling are game changers.',
                                        name: 'Rajesh Kumar',
                                    ...
                                    {
                                        quote: 'The anti-spam engine caught issues we never noticed. Our open rates went from 28% to 61% in three weeks. NapMail pays for itself.',
                                        name: 'Anita Sharma',
                                        role: 'Head of Growth',
                                    ...
                                    {
                                        quote: 'We send 200K emails monthly across 8 SMTP accounts. NapMail handles rotation, throttling, and analytics flawlessly. Zero downtime in 6 months.',
                                        name: 'Vikram Patel',
                                        role: 'CTO',
                    ...
                    <div className="max-w-5xl mx-auto bg-slate-900 rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
                                Join businesses using NapMail for better deliverability. Start free today.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Link to="/napcrm" className="px-10 py-5 bg-white/10 text-white border border-white/20 rounded-xl font-bold text-lg hover:bg-white/20 transition-all backdrop-blur-sm">
                                    Explore NapCRM
                                </Link>
                            </div>
                        </div>
