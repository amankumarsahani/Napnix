...
const navItems = [
  ...
  { label: 'NapCRM', path: '/napcrm', children: [
    ...
    { label: 'Education', path: '/napcrm/industries/education' },
    { label: 'Hospitality', path: '/napcrm/industries/hospitality' },
    { label: 'Restaurant', path: '/napcrm/industries/restaurant' },
    { label: 'Salon & Spa', path: '/napcrm/industries/salon' },
    { label: 'Fitness', path: '/napcrm/industries/fitness' },
    { label: 'Travel', path: '/napcrm/industries/travel' },
    { label: 'Legal', path: '/napcrm/industries/legal' },
    { label: 'Manufacturing', path: '/napcrm/industries/manufacturing' },
    { label: 'Logistics', path: '/napcrm/industries/logistics' },
